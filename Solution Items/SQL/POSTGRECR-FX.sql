...
BEGIN
	...
	ELSE
		RETURN QUERY SELECT CMP_ID, CMP_TYP AS CNTR_TYP, CMP_TBL_ID AS CNTR_TBL_ID, CNTR_VRSN_ID AS CNTR_VRSN_ID, CNTR_TYP AS CMP_TYP, CNTR_TBL_ID AS CMP_TBL_ID, CMP_VRSN_ID AS CMP_VRSN_ID, CAST(CMP_ROL_TYP + 1 AS NUMERIC(12,0)) AS CMP_ROL_TYP FROM CMP_TBL
