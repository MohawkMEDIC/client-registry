...
>
    ...
    <div class="panel panel-default" id="pnl{@id}">
      <div class="panel-heading">
        <h5 class="panel-title">
          <a data-toggle="collapse" data-parent="components{../@id}{../@verId}" href="#body{@id}">
            Device <xsl:value-of select="@name"/>
          </a>
        </h5>
      </div>
      <div class="panel-body panel-collapse collapse" id="body{@id}">
  ...
  <xsl:template match="marc:person" mode="child">
    <div class="panel panel-default" id="pnl{@id}{@verId}">
      <div class="panel-heading">
        <h5 class="panel-title">
          <a data-toggle="collapse" data-parent="components{../@id}{../@verId}" href="#body{@id}{@verId}">
            Person <xsl:value-of select="@id"/> (Version <xsl:value-of select="@verId"/>)
          </a>
        </h5>
      </div>
      <div class="panel-body panel-collapse collapse" id="body{@id}{@verId}">
        <xsl:call-template name="role"/>
        <xsl:call-template name="status"/>
        <div class="row">
          <div class="col-md-2">
  ...
  <xsl:template name="id">
    ...
    (Domain <a href="/oid/view/{@domain}"><xsl:value-of select="@domain"/></a>)
  </xsl:template>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <xsl:choose>
          ...
          <xsl:when test="@status = 'Obsoleted'">
