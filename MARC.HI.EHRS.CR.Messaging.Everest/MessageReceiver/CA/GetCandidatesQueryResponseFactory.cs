...
namespace MARC.HI.EHRS.CR.Messaging.Everest.MessageReceiver.CA
{
    ...
    public class GetCandidatesQueryResponseFactory : IQueryResponseFactory
    {
        ...
        public MARC.Everest.Interfaces.IInteraction Create(MARC.Everest.Interfaces.IInteraction request, RegistryQueryResult results, List<MARC.Everest.Connectors.IResultDetail> details)
        {
            ...
            List<MARC.Everest.RMIM.CA.R020403.MFMI_MT700746CA.Subject2<MARC.Everest.RMIM.CA.R020403.PRPA_MT101102CA.IdentifiedEntity>> retHl7v3 = new List<MARC.Everest.RMIM.CA.R020403.MFMI_MT700746CA.Subject2<MARC.Everest.RMIM.CA.R020403.PRPA_MT101102CA.IdentifiedEntity>>(results.Results.Count());
            ...
            {
                var retRec = new MARC.Everest.RMIM.CA.R020403.MFMI_MT700746CA.Subject2<MARC.Everest.RMIM.CA.R020403.PRPA_MT101102CA.IdentifiedEntity>(
                    dCompUtil.CreateRegistrationEventDetailEx(res, details)
                );
                if (retRec.RegistrationEvent  == null)
                    retRec = new MARC.Everest.RMIM.CA.R020403.MFMI_MT700746CA.Subject2<MARC.Everest.RMIM.CA.R020403.PRPA_MT101102CA.IdentifiedEntity>(
                        new MARC.Everest.RMIM.CA.R020403.MFMI_MT700746CA.RegistrationEvent<MARC.Everest.RMIM.CA.R020403.PRPA_MT101102CA.IdentifiedEntity>()
                        {
