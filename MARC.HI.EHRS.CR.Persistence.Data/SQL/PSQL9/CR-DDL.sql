...
CREATE INDEX CMP_CNTR_TYP_ID_IDX ON CMP_TBL (CNTR_TYP, CNTR_TBL_ID, CNTR_VRSN_ID);

-- @INDEX
-- LOOKUP COMPONENT BY COMPONENT IDENTIFIER
CREATE INDEX CMP_CMP_IDX ON CMP_TBL(CMP_TBL_ID);
CREATE INDEX CMP_CMP_TYP_ID_IDX ON CMP_TBL (CMP_TYP, CMP_TBL_ID, CMP_VRSN_ID);
