...
BEGIN
	...
	END IF;
	INSERT INTO PSN_ALT_ID_TBL (ID_DOMAIN, ID_VALUE, PSN_ID, EFFT_VRSN_ID, IS_HCN, ID_PURP_CD_ID, ID_AUTH)
		VALUES (ID_DOMAIN_IN, ID_VALUE_IN, PSN_ID_IN, PSN_VRSN_ID_IN, IS_HCN_IN, ID_PURP_IN, ID_AUTH_IN);
	RETURN;
EXCEPTION
