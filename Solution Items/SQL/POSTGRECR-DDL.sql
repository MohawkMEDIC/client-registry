...
(
	...
	EFFT_VRSN_ID	DECIMAL(20,0) NOT NULL, -- THE VERSION IDENTIFIER WHERE THIS DATA BECAME EFFECTIVE
	OBSLT_VRSN_ID	DECIMAL(20,0), -- THE VERSION IDENTIFIER WHERE THIS DATA BECAME OBSOLETE
	CONSTRAINT PK_PSN_ALT_ID_TBL PRIMARY KEY (ID_DOMAIN, ID_VALUE),
...
(
	...
	MODE_CS		CHAR(1) NOT NULL DEFAULT 'W', -- THE MODE OF UNDERSTANDING (W = WRITTEN, V = VERBAL, F = FLUENT)
	...
	CONSTRAINT CK_PSN_LANG_MODE_CS CHECK (MODE_CS IN ('F','W','V'))
);
