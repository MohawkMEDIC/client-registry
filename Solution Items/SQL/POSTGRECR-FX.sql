...
BEGIN
	...
	-- GET THE NAME VALUE
	SELECT NAME_ID INTO NAME_VALUE_ID FROM NAME_CDTBL WHERE NAME_VALUE = NAME_VALUE_IN;
...
$$
BEGIN
	RETURN QUERY SELECT * FROM PSN_NAME_SET_TBL WHERE PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ)) - 1;
END;
$$ LANGUAGE plpgsql;
...
$$
BEGIN
	RETURN QUERY SELECT * FROM PSN_ADDR_SET_TBL WHERE PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ)) - 1;
END;
$$ LANGUAGE plpgsql;
...
$$
BEGIN
	IF EXISTS (SELECT PSN_ID FROM PSN_ALT_ID_TBL WHERE ID_DOMAIN = ID_DOMAIN_IN AND ID_VALUE = ID_VALUE_IN AND IS_HCN = TRUE) THEN
		RAISE EXCEPTION 'CR002: ALTERNATE IDENTIFIER ALREADY REGISTERED';
	END IF;
	INSERT INTO PSN_ALT_ID_TBL (ID_DOMAIN, ID_VALUE, PSN_ID, EFFT_VRSN_ID, IS_HCN, ID_PURP_CD_ID)
...
$$
BEGIN
	RETURN QUERY SELECT * FROM PSN_ALT_ID_TBL WHERE PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ)) - 1;
END
$$ LANGUAGE plpgsql;
...
$$
BEGIN
	RETURN QUERY SELECT * FROM PSN_TEL_TBL WHERE PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ)) - 1;
END
$$ LANGUAGE plpgsql;
...
BEGIN
	...
	END IF;
	RETURN QUERY SELECT * FROM PSN_RLTNSHP_TBL WHERE SRC_PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ)) - 1;
END
$$ LANGUAGE plpgsql;
...
BEGIN
	...
	END IF;
	RETURN QUERY SELECT * FROM PSN_RLTNSHP_TBL WHERE SRC_PSN_ID = SRC_PSN_ID_IN AND TRG_PSN_ID = TRG_PSN_ID_IN AND SRC_PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ)) - 1;
END
$$ LANGUAGE plpgsql;
...
$$
BEGIN
	RETURN QUERY SELECT * FROM PSN_RACE_TBL WHERE PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ)) - 1;
END
$$ LANGUAGE plpgsql;
...
$$
BEGIN
	RETURN QUERY SELECT * FROM PSN_LANG_TBL WHERE PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ)) - 1;
END
$$ LANGUAGE plpgsql;
