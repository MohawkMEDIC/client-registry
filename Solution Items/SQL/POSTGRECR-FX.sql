...
(
	SRC_PSN_ID_IN		IN DECIMAL(20),
	TRG_PSN_VRSN_ID_IN	IN DECIMAL(20,0),
	TRG_PSN_ID_IN		IN DECIMAL(20)
) RETURNS SETOF PSN_RLTNSHP_TBL
AS
$$
BEGIN
	...
	END IF;
	RETURN QUERY SELECT * FROM PSN_RLTNSHP_TBL WHERE PSN_ID = PSN_ID_ID AND TRG_PSN_ID = TRG_PSN_ID_IN AND SRC_PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_VRSN_SEQ));
END
$$ LANGUAGE plpgsql;
