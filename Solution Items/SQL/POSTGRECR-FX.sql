...
$$
BEGIN
	RETURN QUERY SELECT * FROM PSN_NAME_SET_TBL WHERE PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ));
END;
$$ LANGUAGE plpgsql;
...
$$
BEGIN
	RETURN QUERY SELECT * FROM PSN_ADDR_SET_TBL WHERE PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ));
END;
$$ LANGUAGE plpgsql;
...
$$
BEGIN
	RETURN QUERY SELECT * FROM PSN_ALT_ID_TBL WHERE PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ));
END
$$ LANGUAGE plpgsql;
...
$$
BEGIN
	RETURN QUERY SELECT * FROM PSN_TEL_TBL WHERE PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ));
END
$$ LANGUAGE plpgsql;
...
BEGIN
	...
	END IF;
	RETURN QUERY SELECT * FROM PSN_RLTNSHP_TBL WHERE SRC_PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ));
END
$$ LANGUAGE plpgsql;
...
BEGIN
	...
	END IF;
	RETURN QUERY SELECT * FROM PSN_RLTNSHP_TBL WHERE SRC_PSN_ID = SRC_PSN_ID_IN AND TRG_PSN_ID = TRG_PSN_ID_IN AND SRC_PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ));
END
$$ LANGUAGE plpgsql;
...
$$
BEGIN
	RETURN QUERY SELECT * FROM PSN_RACE_TBL WHERE PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ));
END
$$ LANGUAGE plpgsql;
...
$$
BEGIN
	RETURN QUERY SELECT * FROM PSN_LANG_TBL WHERE PSN_ID = PSN_ID_IN AND PSN_VRSN_ID_IN BETWEEN EFFT_VRSN_ID AND COALESCE(OBSLT_VRSN_ID, (SELECT max_value FROM PSN_SEQ));
END
$$ LANGUAGE plpgsql;
