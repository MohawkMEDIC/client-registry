...
namespace MARC.HI.EHRS.CR.Messaging.Everest
{
    ...
    public partial class CaComponentUtil : ComponentUtil
    {
        ...
        /// </summary>
        internal RegistrationEvent CreateQueryMatch(MARC.Everest.RMIM.CA.R020403.MFMI_MT700751CA.ControlActEvent<MARC.Everest.RMIM.CA.R020403.PRPA_MT101103CA.ParameterList> controlActEvent, List<IResultDetail> dtls, ref List<DomainIdentifier> recordIds)
        {
            ITerminologyService termSvc = Context.GetService(typeof(ITerminologyService)) as ITerminologyService;
            ISystemConfigurationService config = Context.GetService(typeof(ISystemConfigurationService)) as ISystemConfigurationService;
            ...
            // REturn value
            RegistrationEvent retVal = CreateComponents<MARC.Everest.RMIM.CA.R020403.PRPA_MT101103CA.ParameterList>(controlActEvent, dtls);
        ...
        /// </summary>
        internal RegistrationEvent CreateQueryMatch(MARC.Everest.RMIM.CA.R020403.MFMI_MT700751CA.ControlActEvent<MARC.Everest.RMIM.CA.R020403.PRPA_MT101101CA.ParameterList> controlActEvent, List<IResultDetail> dtls, ref List<DomainIdentifier> recordIds)
        {
            ITerminologyService termSvc = Context.GetService(typeof(ITerminologyService)) as ITerminologyService;
            ...
            // REturn value
            RegistrationEvent retVal = CreateComponents<MARC.Everest.RMIM.CA.R020403.PRPA_MT101101CA.ParameterList>(controlActEvent, dtls);
